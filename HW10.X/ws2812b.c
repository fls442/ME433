...
#define LOWTIME 15 // 0.35us number of 48MHz cycles to be low for 0.35uS
#define HIGHTIME 65 // 1.65us number of 48MHz cycles to be high for 1.65uS
...
void ws2812b_setup() {
    ...
    LATBbits.LATB6 = 0;             //B6 is low to start
}
